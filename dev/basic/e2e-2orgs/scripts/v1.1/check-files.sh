...
function check_ca0() {
	...
	ls -l /etc/hyperledger/fabric-ca-server-config/3bdd6008f409a0085cae3b240d5897e829a2883433b45db5ef054849012068ff_sk
	ls -l /etc/hyperledger/fabric-ca-server-config/ca.org1.example.com-cert.pem
	ls -l /etc/hyperledger/fabric-ca-server-config/3bdd6008f409a0085cae3b240d5897e829a2883433b45db5ef054849012068ff_sk
	
	fabric-ca-server start -n ca0 ${V11_IDENTITIES_ALLOWREMOVE} ${V11_AFFILIATIONS_ALLOWREMOVE} --registry.maxenrollments -1 --ca.certfile /etc/hyperledger/fabric-ca-server-config/ca.org1.example.com-cert.pem --ca.keyfile /etc/hyperledger/fabric-ca-server-config/3bdd6008f409a0085cae3b240d5897e829a2883433b45db5ef054849012068ff_sk -b admin:adminpw ${ORG_HYPERLEDGER_FABRIC_SDKTEST_INTEGRATIONTESTS_CA_TLS} --tls.certfile /etc/hyperledger/fabric-ca-server-config/ca.org1.example.com-cert.pem --tls.keyfile /etc/hyperledger/fabric-ca-server-config/3bdd6008f409a0085cae3b240d5897e829a2883433b45db5ef054849012068ff_sk -d
}


function check_ca1() {
	ls -l /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem
	ls -l /etc/hyperledger/fabric-ca-server-config/7960c908a0e505eb28457e3f8781efaaa5dc693c0c7dd44227ab736d20b73e20_sk
	
	ls -l /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem
	ls -l /etc/hyperledger/fabric-ca-server-config/7960c908a0e505eb28457e3f8781efaaa5dc693c0c7dd44227ab736d20b73e20_sk
	
	fabric-ca-server start --registry.maxenrollments -1 --ca.certfile /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem --ca.keyfile /etc/hyperledger/fabric-ca-server-config/7960c908a0e505eb28457e3f8781efaaa5dc693c0c7dd44227ab736d20b73e20_sk -b admin:adminpw ${ORG_HYPERLEDGER_FABRIC_SDKTEST_INTEGRATIONTESTS_CA_TLS} --tls.certfile /etc/hyperledger/fabric-ca-server-config/ca.org2.example.com-cert.pem --tls.keyfile /etc/hyperledger/fabric-ca-server-config/7960c908a0e505eb28457e3f8781efaaa5dc693c0c7dd44227ab736d20b73e20_sk -d
}
